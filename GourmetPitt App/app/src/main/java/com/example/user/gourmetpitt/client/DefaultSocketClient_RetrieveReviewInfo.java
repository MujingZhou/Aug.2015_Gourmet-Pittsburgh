...
public class DefaultSocketClient_RetrieveReviewInfo extends Thread{
    ...
    public DefaultSocketClient_RetrieveReviewInfo(Context context){
    ...
    public void handleSession(){
        try{
            synchronized(context) {
                ...
                oos.writeObject("retrieveReviewInfo");
                oos.flush();
                oos.writeObject(restaurantID);
                oos.flush();

                ObjectInputStream ois = new ObjectInputStream(clientSocket.getInputStream());
                ArrayList<String []> reviewList=(ArrayList<String []>)ois.readObject();

                setReservationListForActivity(reviewList);
...
//                System.out.println(restName.get(0));
    ...
    public void setReservationListForActivity(ArrayList<String []> reviewList){
        this.reviewList=reviewList;
//        String [] singlereview=reviewList.get(0);
//        System.out.println("single review"+singlereview[0]);
    }
