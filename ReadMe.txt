...
1. Finding nearby restaurants(based on longitude & latitude) using Google Maps.
2. Matching flavor for recommendation.
3. Advanced search using keywords and sound.
4. Rating and review interaction.
5. Camera catch and upload/store files using Amazon S3.